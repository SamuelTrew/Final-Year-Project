...
Unfortunately, current methods of robust aggregation lack full understanding of this space and so aren't able to fully protect the users from all of the variety of attacks present.
\\ \\
This paper will cover various forms of robust aggregation, as well as some more simple methods to enhance current existing approaches.
